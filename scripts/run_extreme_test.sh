...
# Extreme Load Test Script
# Target: 15000 RPS with load shaping

echo "🚀 Starting Extreme Load Test (15000 RPS, 3 minutes)..."
echo "⚠️  WARNING: This will generate extreme load on the system!"
...
TEST_DIR="results/extreme_test_${TIMESTAMP}"
...
echo "  - Peak users: 3000"
echo "  - Target RPS: 15000+"
echo "  - Results directory: ${TEST_DIR}/"
echo ""

# Run locust test with reduced logging
locust -f load_test_extreme.py \
